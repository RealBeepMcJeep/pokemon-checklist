...
| Dataset | URL | Size |
|---|---|---|
| Learnset per species (move + method + level) | shared cache `learnsets.js` | — |
| Move definitions (power/type/accuracy) | shared cache `moves.js` | — |
| Base stats + ability slots | shared cache `pokedex.js` | — |
